...
public class ContactActivity extends AppCompatActivity {
    ...
    String LienHe = "Với mong muốn đem đến những giây phút nghỉ ngơi tuyệt vời nhất cho quý khách hàng, Dubai Hotel sẽ không ngừng hoàn thiện và nâng cao chất lượng dịch vụ. Hãy liên hệ với chúng tôi khi có bất kì thắc mắc, phản hồi hoặc có nhu cầu muốn đặt phòng.\n" +
            "\n" +
            ...
            "\n" +
            "Email: dubaihoteldn@gmail.com\n" +
            "\n" +
            "Facebook: www.facebook.com/dubaihoteldn";
    @Override
